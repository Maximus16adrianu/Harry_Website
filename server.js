...
let accountGlobalTimestamps = [];
let globalAccountLockUntil = 0;
let accountIPData = {};

let newsletterGlobalTimestamps = [];
let globalNewsletterLockUntil = 0;
let newsletterIPData = {};

let bugReportIPData = {};

let globalApiKeyFailures = [];
let globalApiKeyLockUntil = 0;
// -----------------------------
